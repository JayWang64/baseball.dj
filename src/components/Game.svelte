<script>
  ...
  function toggleOrder() {
    orderOpen = !orderOpen
    localStorage.setItem('dj.orderOpen', orderOpen ? '1' : '0')
  }
...
<div class="screen-row">
  ...
  {#if batter}
    <button class="order-toggle" class:active={orderOpen} onclick={toggleOrder}>
      ☰ ORDER
    </button>
  {/if}
</div>

<div class="game-layout" class:split={orderOpen && batter}>
  <div class="game-main">
    {#if !batter}
